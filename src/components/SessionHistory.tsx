                ...
                return (
                  <Card key={index} className="border-gray-200 hover:border-green-300 transition-colors">
                    <CardContent className="p-6">
                      ...
                      {/* Model Parameters Section - Improved formatting */}
                      <div className="mb-4 p-3 bg-gray-50 rounded-lg border">
                        <span className="font-medium text-gray-700 text-sm block mb-2">Model Parameters:</span>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                          <div className="flex justify-between">
                            <span className="text-gray-600">Temperature:</span>
                            <span className="font-mono text-gray-800">{session.temperature}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Top-p:</span>
                            <span className="font-mono text-gray-800">{session.top_p}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Frequency Penalty:</span>
                            <span className="font-mono text-gray-800">{session.frequency_penalty}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Presence Penalty:</span>
                            <span className="font-mono text-gray-800">{session.presence_penalty}</span>
                          </div>
                        </div>
                      </div>
